...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.DataSources.ActiveOrderDataSource", b =>
                {
                    ...
                    b.Property<int>("JoySellId")
                        .HasColumnType("integer");

                    b.Property<DateTime>("OrderTime")
                        .HasColumnType("timestamp without time zone");

                    b.HasKey("OrderId", "JoySellId");

                    b.HasIndex("JoySellId");
            ...
            modelBuilder.Entity("Data.DataSources.JoySellDataSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Data.DataSources.SelectedCompositionDataSource", b =>
                {
                    ...
                    b.Property<int>("CompositionId")
                        .HasColumnType("integer");
                    b.HasKey("JoySellId", "CompositionId");
            ...
            modelBuilder.Entity("Data.DataSources.ActiveOrderDataSource", b =>
                {
                    b.HasOne("Data.DataSources.IceCreamDataSource", "JoySell")
                        .WithMany("Orders")
                        .HasForeignKey("JoySellId")
