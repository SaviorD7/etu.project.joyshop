    ...
    public partial class PostgreSQLMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Joys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JoySellId = table.Column<int>(nullable: false),
                    CompositionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectedComposition", x => new { x.JoySellId, x.CompositionId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_SelectedComposition_Joys_JoySellId",
                        column: x => x.JoySellId,
                        principalTable: "Joys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveOrders", x => new { x.OrderId, x.JoySellId });
                    table.ForeignKey(
                        name: "FK_ActiveOrders_Joys_JoySellId",
                        column: x => x.JoySellId, principalTable: "Joys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
